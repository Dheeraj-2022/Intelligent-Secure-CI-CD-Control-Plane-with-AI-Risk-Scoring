...
(by the DNS naming spec). If release name contains chart name, use the release
name as the full name.
*/}}
...
{{/*
Create chart label value used by labels and selectors.
*/}}
...
{{/*
Return the image reference as registry/repository:tag.
*/}}
